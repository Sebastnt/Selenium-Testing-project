...
public class OrderFormDelivery extends BasePage {
	...
	public WebElement getCompanyField() throws InterruptedException, IOException {
		this.driver = getDriver();
		return driver.findElement(companyNameField);
	}
	
	public WebElement getAddressField() throws InterruptedException, IOException {
		this.driver = getDriver();
		return driver.findElement(addressField);
	}
	
	public WebElement getAddressCompField() throws InterruptedException, IOException {
		this.driver = getDriver();
		return driver.findElement(addressComplementField);
	}
	
	public WebElement getCityField() throws InterruptedException, IOException {
		this.driver = getDriver();
		return driver.findElement(cityField);
	}
	
	public WebElement getStateDropdown() throws InterruptedException, IOException {
		this.driver = getDriver();
		return driver.findElement(stateDropdown);
	}
	
	public WebElement getPostcodeField() throws InterruptedException, IOException {
		this.driver = getDriver();
		return driver.findElement(postcodeField);
	}
	
	public WebElement getCountryDropdown() throws InterruptedException, IOException {
		this.driver = getDriver();
		return driver.findElement(countryDropdown);
	}

	public WebElement getPhoneField() throws InterruptedException, IOException {
		this.driver = getDriver();
