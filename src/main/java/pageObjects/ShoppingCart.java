...
public class ShoppingCart extends BasePage {
	...
	public WebElement getHavePromo() throws InterruptedException, IOException {
	...
	public WebElement getPromoAddBtn() throws InterruptedException, IOException {
		this.driver = getDriver();
		return driver.findElement(promoAddBtn);
	}
	
	public WebElement getProceedCheckoutBtn() throws InterruptedException, IOException {
		this.driver = getDriver();
		return driver.findElement(proceedToCheckoutBtn);
	}
	
	public WebElement getDeleteItemOne() throws InterruptedException, IOException {
		this.driver = getDriver();
		return driver.findElement(deleteItemOne);
	}
	
	public WebElement getDeleteItemTwo() throws InterruptedException, IOException {
		this.driver = getDriver();
		return driver.findElement(deleteItemTwo);
	}
	
	public WebElement getTotalAmount() throws InterruptedException, IOException {
		this.driver = getDriver();
